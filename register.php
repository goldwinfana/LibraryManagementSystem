                ...
                <div class="card-body">
                    ...
                    <form id="regForm" method="POST" action="customRegister.php" onsubmit="return sendForm()">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control is-invalid" name="email" maxlength="30" onkeyup="validateEmail()"  required autocomplete="">
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="idNo" class="col-md-4 col-form-label text-md-right">ID Number</label>

                            <div class="col-md-6">
                                <input id="idNo" type="text" class="form-control is-invalid" name="idNo" minlength="13" maxlength="13" onkeypress="return /[0-9]/i.test(event.key)" onkeyup="validateID()" required autocomplete="off">
                            </div>
                            <span class="invalid-feedback text-center" role="alert" style="display: block">
                        ...
                        <input id="gender" type="text" class="form-control is-invalid" name="gender" hidden>
...
<!---->
<!--                            <div class="col-md-6">-->
<!--                                <input id="mobile" type="text" class="form-control is-invalid" name="mobile" onkeypress="return /[0-9]/i.test(event.key)" >-->
<!--                            </div>-->
<!--                            <span class="invalid-feedback text-center" role="alert" style="display: block">-->
