                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistic-block block">
                            <div class="progress-details d-flex align-items-end justify-content-between">
                                <div class="title">
                                    <div class="icon"><i class="fa fa-hourglass-half fa-fw pending"></i></div><h15 class="pending">Pending Books (0)</h15>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistic-block block">
                            <div class="progress-details d-flex align-items-end justify-content-between">
                                <div class="title">
                                    <div class="icon"><i class="fa fa-check-circle" style="color: cornflowerblue"></i></div><h15 style="color: cornflowerblue">Returned Books (0)</h15>
                                </div>
                                <div class="number"></div>
                            </div>
                            <div class="progress progress-template">
